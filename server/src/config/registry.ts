...
export const GROUPS: ConfigGroup[] = [
  ...
  { id: 'tts-engine', label: 'TTS engine & device', help: 'Voice engine device, language, and preload behaviour.', risk: 'high', collapsedByDefault: true },
  { id: 'tts-batching', label: 'TTS batching & throughput', help: 'Batch sizing and generation concurrency.', risk: 'medium', collapsedByDefault: false },

...
export async function probeSidecarHealth(): Promise<SidecarHealthResult> {
  ...
  try {
    ...
    return {
      ...
      qwenInstallState: qwenInstallState,
      coquiPackageInstalled: body.coqui_package_installed === true,
      kokoroPackageInstalled: body.kokoro_package_installed === true,
      whisperPackageInstalled: body.whisper_package_installed === true,

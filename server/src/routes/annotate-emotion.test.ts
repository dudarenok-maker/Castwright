...
const SENTENCES = [
  ...
  { id: 2, chapterId: 1, characterId: 'sophie', text: '“Get down!”' },
  { id: 3, chapterId: 2, characterId: 'keefe', text: '“It will be okay,” he whispered.' },
];
...
describe('POST /api/books/:bookId/annotate-emotion', () => {
  ...
  it('sends the already-attributed sentences (id/characterId/text) and never asks for re-attribution', async () => {
    ...
    expect(prompt).toContain('"characterId": "sophie"');

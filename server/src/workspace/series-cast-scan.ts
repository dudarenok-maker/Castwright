/* Series-scoped slice of scanLibraryCharacters. Returns every confirmed
   ...
   Unlocked's per-chapter detector recognises Sophie / Keefe / Elwin /
   Biana etc. from the 41 confirmed characters across KOTLC + Bonus
   Keefe Story rather than re-detecting them as fresh entities.

   Single-series scoped on purpose: cross-series carry-over (e.g. Sophie

...
# for instruct-baseline.json's tolerances block (rtf_max etc.) -- required
# whenever a `--bless` would move a THRESHOLD rather than just re-record a
# measurement (see compare.bless_guard_thresholds, #1995).
#

...
Describe 'Get-CastReconciliationSummary' {
    ...
    It 'tallies cast.json characters and surfaces them as a sorted unique list' {
        ...
        $summary.CastCharacterIds | Should -Contain 'sophie'
        $summary.CastCharacterIds | Should -Contain 'keefe'
    }
    ...
    It 'identifies orphan characterIds -- sentences referencing ids absent from cast.json (Unlocked regression)' {
        ...
        $edits = @{ sentences = @(
            ...
            @{ id = 2; chapterId = 1; characterId = 'keefe';    text = 'b' },
            @{ id = 3; chapterId = 2; characterId = 'elwin';    text = 'c' },
        ...
        $summary.OrphanCharacterIds | Should -Contain 'keefe'
        $summary.OrphanCharacterIds | Should -Contain 'elwin'
        $summary.OrphanCharacterIds | Should -Contain 'sophie'

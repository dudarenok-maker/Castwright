...
/* Shared by every `?e2eXxx=` mock-override seam below (mock mode is
   in-process, so page.route can't intercept) — a single URLSearchParams
   read wrapped in try/catch, falling back to null on a malformed search
   string rather than throwing during a mount. */
function readE2eSearchParam(search: string, param: string): string | null {
  try {
...
/* bug #1298 — e2e seam: `?e2eWorkspaceRoot=<path>` forces a realistic (long)
   ...
   ever trigger a max-width bug. Pure + exported so it's unit-tested
   directly. */
export function readE2eWorkspaceRootOverride(search: string): string | null {
  return readE2eSearchParam(search, 'e2eWorkspaceRoot');
}
...
const MOCK_CONFIG_GROUPS: import('./types').ConfigGroup[] = [
  ...
  },
  {
    ...
    help: 'GPU concurrency, VRAM budgets, and sidecar recycling. Footguns live here.',
    risk: 'high',
    collapsedByDefault: true,
  },
  {
...
const MOCK_CONFIG_VALUES: import('./types').ConfigValues = {
  ...
  'analyzer.ollama.retryTemperature': {
    key: 'analyzer.ollama.retryTemperature',
    effective: 0.6,
    source: 'default',
    locked: false,
  ...
  'analyzer.gemini.maxOutputTokens': {
    key: 'analyzer.gemini.maxOutputTokens',
    effective: 8192,
    source: 'default',
    locked: false,
  ...
  'analyzer.stage2.chunkCharBudget': {
    key: 'analyzer.stage2.chunkCharBudget',
    effective: 9000,
    source: 'default',
    locked: false,
  ...
  'analyzer.stage1.chunkCharBudget': {
    key: 'analyzer.stage1.chunkCharBudget',
    effective: 24000,
    source: 'default',
    locked: false,
  ...
  'analyzer.stage2.endingTailWords': {
    key: 'analyzer.stage2.endingTailWords',
    effective: 8,
    source: 'default',
    locked: false,
  ...
  'analyzer.stage2.coverageRetries': {
    key: 'analyzer.stage2.coverageRetries',
    effective: 2,
    source: 'default',
    locked: false,
  ...
  'analyzer.ollama.model': {
    key: 'analyzer.ollama.model',
    effective: 'qwen3.5:4b',
    source: 'default',
    locked: false,
    overridden: false,
  },
  ...
  'analyzer.gemini.voiceStyleModel': {
    key: 'analyzer.gemini.voiceStyleModel',
    effective: 'gemini-3.1-flash-lite',
    source: 'default',
    locked: false,
    overridden: false,
  },
  ...
  'analyzer.phase1.minLagChapters': {
    key: 'analyzer.phase1.minLagChapters',
    effective: 10,
    source: 'default',
    locked: false,
  ...
  'prompt.sentenceAttribution': {
    key: 'prompt.sentenceAttribution',
    effective: 'skills/audiobook-sentence-attribution.md',
    source: 'default',
    locked: false,
    overridden: false,
  },
  'prompt.emotionAnnotation': {
    key: 'prompt.emotionAnnotation',
    effective: 'skills/audiobook-emotion-annotation.md',
    source: 'default',
    locked: false,
    overridden: false,
  },
  'prompt.scriptReview': {
    key: 'prompt.scriptReview',
    effective: 'skills/audiobook-script-review.md',
    source: 'default',
    locked: false,
    overridden: false,
  },
  'prompt.instructAnnotation': {
    key: 'prompt.instructAnnotation',
    effective: 'skills/audiobook-instruct-annotation.md',
    source: 'default',
    locked: false,
    overridden: false,
  },
  'prompt.voiceStyle': {
    key: 'prompt.voiceStyle',
    effective: 'skills/audiobook-voice-style.md',
    source: 'default',
    locked: false,
    overridden: false,
  },
  'lan.deviceTokenTtlDays': {
    key: 'lan.deviceTokenTtlDays',
    effective: 30,
    source: 'default',
    locked: false,

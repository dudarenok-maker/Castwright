...
export const TOUR_STEPS: ReadonlyArray<TourStep> = [
  ...
  // 2 · Cast & voices (fe-46 — voice design precedes manuscript review in the flow)
  {
    id: 's6-roster',
    screen: 'cast',
    anchor: 'cast-roster',

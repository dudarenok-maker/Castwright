...
interface Props {
  ...
  onClose: () => void;
  onConfirm: (args: { characterId: string; chapterIds: number[]; reason: string; note: string }) => void;
}

export function CharacterRegenerateModal({ character, chapters, defaultChapterId, onClose, onConfirm }: Props) {

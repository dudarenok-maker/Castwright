...
export function ThemeToggleButton() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center w-8 h-8 min-h-[44px] min-w-[44px] fine-pointer:min-h-0 fine-pointer:min-w-0 rounded-full bg-ink/4 hover:bg-ink/8 text-ink/70 hover:text-ink transition-colors focus:outline-hidden focus:ring-2 focus:ring-magenta/40"
    >
      {iconFor(currentMode)}
    </button>
  );

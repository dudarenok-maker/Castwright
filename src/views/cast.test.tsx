        ...
        preloadedState: {
          ...
          cast: {
            ...
            orphanedCharacterFallbacks: {
              ...
              // THIS exact shape as damage needing a re-render — the
              // fixture below (formerly register row A29, discharged and renumbered since)
              // is a normalised-id match, not a history one

      ...
      batches: [
        {
          ...
          entries: [
            { characterId: 'sophie', characterName: 'Sophie', quote: 'fabricated 1', truncated: false, reason: 'not_in_source' },
            { characterId: 'sophie', characterName: 'Sophie', quote: 'fabricated 2', truncated: false, reason: 'not_in_source' },
            { characterId: 'keefe',  characterName: 'Keefe',  quote: '   ', truncated: false, reason: 'empty_after_normalisation' },
          ],
        },
      ],
    });

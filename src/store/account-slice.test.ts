...
describe('accountSlice — Analyzer card (#3141 step 2 — now read-only, resolver-derived)', () => {
...
describe('per-phase analyzer selectors (plan 118)', () => {
  ...
  it('selectAnalyzerPhase1MinLag returns the resolved server value', () => {
    expect(selectAnalyzerPhase1MinLag({ ...base, analyzerPhase1MinLagChapters: 10 })).toBe(10);

...
const TITLES = {
  ...
  'analyzer-reasoning-overflow': 'Analyzer used its output limit on reasoning',
  'analyzer-timeout': 'Analyzer request ran past its time limit',

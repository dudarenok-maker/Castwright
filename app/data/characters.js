...
const initialCharacters = [
  {
    id: "narrator", name: "Narrator", role: "Third-person omniscient", color: "narrator",
    lines: 312, scenes: 24,
    attributes: ["Neutral","Mid-tempo","Mid-Atlantic","Warm"],
    tone: { warmth: 60, pace: 50, authority: 55, emotion: 30 },
    voiceId: "v_anders",
    voiceState: "reused",  // generated | tuned | reused | locked
  ...
  {
    id: "halloran", name: "Captain Halloran", role: "Captain of the Northern Star", color: "halloran",
    lines: 247, scenes: 18,
  ...
  {
    id: "eliza", name: "Eliza Gray", role: "Reluctant stowaway", color: "eliza",
    lines: 412, scenes: 22,
  ...
  {
    id: "marcus", name: "Marcus the Cook", role: "Ship's cook", color: "marcus",
    lines: 86, scenes: 11,
...
Object.assign(window, { initialCharacters });

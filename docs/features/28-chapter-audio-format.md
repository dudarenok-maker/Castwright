...
`C:\Users\dudar\Downloads\the Coalfall Commission.txt` — see the recipe below.
...
`C:\Users\dudar\Downloads\the Coalfall Commission.txt` — Keeper of the Lost
Cities bonus story by Della Renwick. Multi-character (Marlow, Oduvan,

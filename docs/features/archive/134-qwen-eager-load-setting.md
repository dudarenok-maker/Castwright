...
Shipped 2026-05-29 · `9ba8eb6` (feat(frontend,server): engine-aware eager-load toggle + Qwen-aware sidecar settings). The resolved-default-aware toggle + `eagerLoadQwen` → `PRELOAD_QWEN` wiring locked by the user-settings + spawn-sidecar tests.

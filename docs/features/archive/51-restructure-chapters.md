...
Against the real backend, the same walkthrough works on the canonical `C:\Users\dudar\Downloads\the Coalfall Commission.txt` book the user uploaded that motivated this plan.

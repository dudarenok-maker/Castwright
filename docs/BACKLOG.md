...
**Counts as of 2026-05-17:** Must 0 · Should 13 · Could 13 · Won't 13
...
### 13. Adjustable cover framing + local-disk upload
...
- *Depends on:* none structural (plan 36's data model and endpoints are extended, not replaced). Should slot in before Should #6 (`state.json` schema versioning) so the additive shape gets captured when versioning lands.

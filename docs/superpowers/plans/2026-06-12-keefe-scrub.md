...
> **STATUS: DELIVERED (2026-06-13)** on branch `chore/keefe-scrub`. All six
> phases plus a wider clean-up landed; the whole tree is grep-clean of KotLC IP
> except this plan, the scope spec, and `docs/test-book/kotlc-to-coalfall-mapping.md`
...
> `scripts/**` tree, `openapi.yaml`, the de-facto author name "Shannon Messenger"
...
> fixtures, `server/tts-sidecar/tests`, `server/.env.example`, the Dex long-form
> "Dexter Alvin Diznee" (+ Dexter/Dexy/Dizz), and the surname/pet/place long
> tail (Vacker/Dizznee/Ruewen/Alvar/Iggy/Verdi/Silveny/Foxfire/Eternalia/

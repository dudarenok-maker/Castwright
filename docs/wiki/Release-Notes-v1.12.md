Covers the whole v1.12.x line: the v1.12.0 minor release plus its two
same-day-and-next-day patches. [v1.12.0 on GitHub](https://github.com/dudarenok-maker/Castwright/releases/tag/v1.12.0) ·

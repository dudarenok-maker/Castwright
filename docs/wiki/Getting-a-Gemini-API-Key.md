...
4. Back in Castwright, go to **Admin → Model Manager → Server configuration → Gemini API key**, paste the key into the field, and click **Save key**. (The same field appears in the setup wizard's Analysis step, and a **"Get a Gemini API key"** link beside it brings you back to this page.)

...
### 2.2 Wave-3 agent-runnable (16 rows)
...
A29, A39, A40, A41, A42, A45, B1, B3, B4, C1, C2, C3, C4, E11, G1, G2. (Named
...
— added by the 2026-08-22 correction above.)

**Row count:** 6 (group A: A29, A39, A40, A41, A42, A45 — A27 discharged,
removed) + 3 (B: B1, B3, B4 — B2 retired, removed) + 4 (C) + 1 (E11 — E8
moved to Blocked, removed) + 2 (G) = **16** (was 15 before A45's addition,
...
**49** (operator) + **16** (wave-3) + 3 (blocked) = **68**. Every register row
...
- **Wave-3 agent-runnable:** 16 rows (was 18 before wave 4 — A27 discharged
  and old-E8 moved to Blocked and B2 retired 2026-08-21, see §2.1/§2.2; then
  15 → 16 as A45/PR #2588 joined 2026-08-22), no GPU, run off-box by the
  wave-3 pass — not counted in operator minutes.

**Grand reconciliation:** 49 operator + 16 wave-3 + 3 blocked = **68 rows**, the

...
- [ ] A41: a copy of the venv, deliberately clobbered — row's own words
  ...
  instead. Use the register's current A41 row for the actual recipe, not
  this citation.**

# On-box sitting pack — multi-language render + ASR content-QA (D2, A27; D1/E4 discharged)

> **Sitting pack** for wave 2 of `#2435`, step 7 of the `#2453` chain. Covers
> register rows **D2, A27** — zh/ja placeholder voice design and sidecar 
> auto-scaled RAM/VRAM recycle thresholds. Sections for D1 (discharged 2026-09-07) 
> and E4 (discharged 2026-09-06) are retained below for historical context. Follows the shared
...
> D2 ≈ 25, A35 ≈ 35, E4 ≈ 15. Sum = 165, matching the plan of record's stated
...
### A27 · Sidecar auto-scaled RAM/VRAM recycle thresholds now actually apply on a fresh install ([#2179](https://github.com/dudarenok-maker/Castwright/issues/2179), PR [#2210](https://github.com/dudarenok-maker/Castwright/pull/2210))

> **Criteria source:** `onbox-acceptance-register.md` A27 (`:2169-2209`).
...
- **A35** — `gh issue view 2179` closed, `gh pr view 2210` merged, both match

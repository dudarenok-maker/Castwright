...
### A44 · #2128 — a real re-render actually clears an audio-currency row ([#2128](https://github.com/dudarenok-maker/Castwright/issues/2128), plan [280](../features/archive/280-cast-identity-followups.md)) · **single 8 GB card for the re-render; the two dry runs need no GPU, server stopped**

...
- **Emotions that still sound like your character — and a higher-quality voice when you want one.** When a character gets angry, drops to a whisper, or softens with sadness, the voice stays *theirs* — the feeling is performed by the character's own voice instead of a stand-in that wandered off-character. And for a character you want at their very best, a new "Higher quality" setting performs them on a larger, more expressive model, while your everyday voices stay quick.
- **Characters that gasp, sigh, and laugh.** Beyond the words on the page, Castwright now performs the small human sounds between them — a caught breath, a soft laugh, a sigh — written in by the same pass that reads your book, and delivered with a sense of how each line should land. It's a higher-fidelity mode you switch on per book; your everyday performances are left exactly as they were.
...
- **A second read of who-said-what.** Ask Castwright to review a chapter and it reads back over the script for the small mistakes that creep into attribution — a stray speaker tag, a line that belongs to two people, a dialogue buried in narration, an emotion that doesn't fit — and offers each fix for you to accept or wave off, one at a time or all at once.

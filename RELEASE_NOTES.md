...
- **Numbers and dates, read the way you'd say them.** A price, a year, a percentage, a title — `$1,200`, `1999`, `50%`, `Dr.` — is now spoken aloud the way a narrator would read it, not stumbled through character by character, in English, Spanish and Russian alike. It happens on its own, and your manuscript on the page is left exactly as you wrote it.
